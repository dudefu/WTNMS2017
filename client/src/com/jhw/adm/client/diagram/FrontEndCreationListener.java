...
public class FrontEndCreationListener implements ItemListener, ActionListener {

    public FrontEndCreationListener(EquipmentCreationTool t, DrawingEditor editor) {
        this.tool = t;
        this.editor = editor;
    ...
    public void itemStateChanged(ItemEvent evt) {
        if (evt.getStateChange() == ItemEvent.SELECTED) {
        	FrontEndEdit nodeEdit = new FrontEndEdit();
