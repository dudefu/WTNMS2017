...
public class SmartSelectionTool extends AbstractTool {
	...
	/**
	 * Returns the value of the selectBehindEnabled property. This is a bound
	 * property.
	 * 
	...
	protected HandleTracker getHandleTracker(Handle handle) {
		...
		handleTracker
				.setHandles(handle, getView().getCompatibleHandles(handle));
...
//            dragTracker = new DefaultDragTracker();
			dragTracker = new ConstrainedDragTracker();
		}
...
//			selectAreaTracker = new DefaultSelectAreaTracker();
			selectAreaTracker = new SmartSelectAreaTracker();
		}
		return selectAreaTracker;
	}

	/**
	 * Method to set a {@code HandleTracker}. If you specify null, the {@code
	 * SelectionTool} uses the {@code DefaultHandleTracker}.
	 */
	...
	/**
	 * Method to set a {@code DragTracker}. If you specify null, the {@code
	 * SelectionTool} uses the {@code DefaultDragTracker}.
	 */
