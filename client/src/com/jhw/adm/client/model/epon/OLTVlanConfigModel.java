...
@Component(OLTVlanConfigModel.ID)
public class OLTVlanConfigModel implements Serializable{
	public static final String ID = "OLTVlanConfigModel";
	
	private VlanConfig vlanConfig = null;
	
	private static final Logger LOG = LoggerFactory.getLogger(OLTVlanConfigModel.class);
	...
	@Autowired
	@Qualifier(OLTVlanTableModel.ID)
	private OLTVlanTableModel vlanTableModel;
	
	
	@Autowired
	@Qualifier(OLTVlanPortModel.ID)
	private OLTVlanPortModel vlanPortModel;
	...
	public OLTVlanTableModel getVlanTableModel(){
		return vlanTableModel;
	}
	
	public OLTVlanPortModel getVlanPortModel(){
