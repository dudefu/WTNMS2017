...
@Component(OLTVlanPortModel.ID)
public class OLTVlanPortModel extends AbstractTableModel{
	public static final String ID = "OLTVlanPortModel";
	...
	private static final Logger LOG = LoggerFactory.getLogger(OLTVlanPortModel.class);
