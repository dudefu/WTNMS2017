...
@Component(VlanMemberTableModel.ID)
public class VlanMemberTableModel extends AbstractTableModel{
	public static final String ID = "vlanMemberTableModel";
	...
	private static final Logger LOG = LoggerFactory.getLogger(VlanMemberTableModel.class);
