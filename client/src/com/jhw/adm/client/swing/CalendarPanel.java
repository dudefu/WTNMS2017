...
public class CalendarPanel extends JPanel{
     ...
     * @version 1.0
     */
    class JDayLabel extends JLabel{
        private ImageIcon todayIcon = getOpenSwingImage("today.gif", new ImageIcon());
        ...
        public ImageIcon getOpenSwingImage(String name, ImageIcon defaultIcon) {
        	ImageIcon icon = null;
        	try {
//        			java.net.URL url = ClassLoader.getSystemResource(
//        					"" + name);
        			java.net.URL url = new java.net.URL("file:///D:/workspace/ADM2010/res/images/today.gif");
