...
public class MessageOfSwitchUpgradeProcessorStrategy implements MessageProcessorStrategy {
	
	private static final Logger LOG = LoggerFactory.getLogger(MessageOfSwitchUpgradeProcessorStrategy.class);
	...
	public MessageOfSwitchUpgradeProcessorStrategy() {
	...
	private MessageProcessorAdapter messageFedOfflineProcessor = new MessageProcessorAdapter() {//前置机不在线
		...
		public void process(TextMessage message) {
			try {
				...
				LOG.error("MessageOfSwitchUpgradeProcessorStrategy.setStopMessage() error:{}", e);
			}
		}
	};
