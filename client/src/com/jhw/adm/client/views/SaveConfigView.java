...
@Component(SaveConfigView.ID)
@Scope(Scopes.DESKTOP)
public class SaveConfigView extends ViewPart {
	
	private static final long serialVersionUID = 1L;
	public static final String ID = "SaveConfigView";
	...
	private JButton reBootBtn = null;

	private MessageSender messageSender;	
	private ButtonFactory buttonFactory;
	private String IP;
	private int[] rows;
	private String community_public ="public" ;
	private String community_private = "private";
	...
	private static final Logger LOG = LoggerFactory.getLogger(SaveConfigView.class);
		...
		saveBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=0;i<rows.length;i++){
					IP = table.getValueAt(rows[i], 0).toString();
					System.out.println(IP);
					System.out.println(rows[i]);
					String community = "private";
					String oid = "1.3.6.1.4.1.44405.71.2.23.1.0";
					b = SnmpData.snmpSet(IP,community,oid,"1");
				...
				if(false==b){
					JOptionPane.showMessageDialog(null, "      保存配置失败！", "保存失败",JOptionPane.INFORMATION_MESSAGE);
				}
			}
			
		});
		reBootBtn = new JButton("系统重启");
		reBootBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=0;i<rows.length;i++){
					...
					System.out.println(IP);
					System.out.println(rows[i]);
					String oid = "1.3.6.1.4.1.44405.71.2.23.6.0";
					SnmpData.snmpSet(IP,community_private,oid,"1");
					Toolkit.getDefaultToolkit().beep();
				}
				try {
					Thread.sleep(16000);
					JOptionPane.showMessageDialog(null, "      重启系统成功！", "重启系统成功",JOptionPane.INFORMATION_MESSAGE);
