...
@Component(ARPtableView.ID)
@Scope(Scopes.DESKTOP)
public class ARPtableView extends ViewPart implements MessageReceiveInter{
	public static final String ID = "ARPtableView";

	private JScrollPane scrollPnl = new JScrollPane();
	private JTable table = new JTable();
	private ARPTableModel model = null;
...
//		table.setBackground(scrollPnl.getBackground());
	...
	@ViewAction(name=UPLOAD, icon=ButtonConstants.SYNCHRONIZE, desc="向上同步ARP表",role=Constants.MANAGERCODE)
	public void upSynchronize(){
		
	}
	
	@ViewAction(name=EXPORT, icon=ButtonConstants.SYNCHRONIZE, desc="导出ARP表",role=Constants.MANAGERCODE)
	public void export(){
	...
	class ARPTableModel extends AbstractTableModel{
