...
@Component(ForwardtableView.ID)
@Scope(Scopes.DESKTOP)
public class ForwardtableView extends ViewPart implements MessageReceiveInter{
	public static final String ID = "forwardtableView";

	private JScrollPane scrollPnl = new JScrollPane();
	private JTable table = new JTable();
	private ForwardtableModel model = null;
	...
	private final static String[] COLUMN_NAME= {"接口索引","MAC地址","IP地址","类型"};
...
//		table.setBackground(scrollPnl.getBackground());
	...
	@ViewAction(name=UPLOAD, icon=ButtonConstants.SYNCHRONIZE, desc="向上同步转发表",role=Constants.MANAGERCODE)
	public void upSynchronize(){
		
	}
	
	@ViewAction(name=EXPORT, icon=ButtonConstants.SYNCHRONIZE, desc="导出转发表",role=Constants.MANAGERCODE)
	public void export(){
	...
	class ForwardtableModel extends AbstractTableModel{
