...
@Component(RoutetableView.ID)
@Scope(Scopes.DESKTOP)
public class RoutetableView extends ViewPart implements MessageReceiveInter{
	public static final String ID = "routetableView";

	private JScrollPane scrollPnl = new JScrollPane();
	private JTable table = new JTable();
	private RoutetableModel model = null;
	...
	private final static String[] COLUMN_NAME= {"目的地址","网关IP地址","子网掩码","接口索引","类型","协议","年龄","度量1","度量2","度量3","度量4"};
...
//		table.setBackground(scrollPnl.getBackground());
	...
	@ViewAction(name=UPLOAD, icon=ButtonConstants.SYNCHRONIZE, desc="向上同步路由表",role=Constants.MANAGERCODE)
	public void upSynchronize(){
		
	}
	
	@ViewAction(name=EXPORT, icon=ButtonConstants.SYNCHRONIZE, desc="导出路由表",role=Constants.MANAGERCODE)
	public void export(){
