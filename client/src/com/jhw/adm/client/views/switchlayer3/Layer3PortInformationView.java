...
public class Layer3PortInformationView extends ViewPart {
	...
	@ViewAction(name=UPLOAD, icon=ButtonConstants.SYNCHRONIZE, desc="上载三层交换机端口信息",role=Constants.MANAGERCODE)
	public void upload(){
		...
		showUploadMessageDialog(task, "上载端口信息");
	}
	...
	private class SwitchPortLevel3TableModel extends AbstractTableModel{
		...
		private static final String GIGA_PORT = "千兆口";
		private static final String FAST_PORT = "百兆口";
		...
		public SwitchPortLevel3TableModel() {
			...
			portIPColumn.setIdentifier("端口IP");
			portIPColumn.setTitle("端口IP");
