...
public class SnmpDataTest {  
    public static void main(String[] args) throws IOException, InterruptedException {  
        ...
        target.setAddress(new UdpAddress("192.168.5.33/161"));  
...
//        broadcastTarget.setAddress(new UdpAddress("192.168.1.113/161"));  
...
//        Thread.sleep(6000); //main thread wait 6s for the completion of asynchronous request   
    ...
    private static PDU createSetPdu() {  
        PDU pdu = new PDU();  
        pdu.setType(PDU.SET);  
       //pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.71.2.2.4.0"), new OctetString("010000000100000001000000010200"))); //sysName
       pdu.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.71.1.1.0"), new OctetString("a010000000100000001000000010200"))); //sysName  
        return pdu;  
    }  
