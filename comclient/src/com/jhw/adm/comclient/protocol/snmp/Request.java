...
public class Request implements PDUFactory {
	...
	public static void main(String[] args) {
		...
		snmpRequest.setVersion(SnmpConstants.version2c);
		...
		// OctetString("xiongbo")));
		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.1.0")));
		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.2.0")));

		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.3.0")));

		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.6.0")));
		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.7.0")));
		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.8.0")));
		vbs.add(new VariableBinding(new OID("1.3.6.1.4.1.44405.5.1.9.0")));
